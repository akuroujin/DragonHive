...
public partial class XmlTest : Control
{
    ...
    //     List<Attack> attacks = [new Attack("hit", "hits enemy", damages, 5, 1, true, false, false, AbilityScoreTypes.Strength), new()];
    //     List<Spell> spells = [new Spell("hit", "hits enemy", damages, 5, 1, true, false, false, AbilityScoreTypes.Intelligence, 2, 1, 2, elements, 2, 5), new(), new()];
    ...
    //     AbilityScores unitBaseStats = new(10, 12, 12, 10, 5, 16);
    //     BaseStats stats = new(30, 50, 30, 14);
